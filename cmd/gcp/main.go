		...
		&info.InfoImpl{
			Info: &plugin.PluginInfo{
				...
				Parameters: []*plugin.ParameterInfo{
					...
					{Name: common.GcpServiceAccountInIdentitySyncEnabled, Description: "Optional flag to enable/disable the retrieving of service accounts during the identity-store sync. By default this will be enabled", Mandatory: false},
				},
