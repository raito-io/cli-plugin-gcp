...
func (_m *MockIAMRepository) GetGroups(ctx context.Context, configMap *config.ConfigMap, id string) ([]types.GroupEntity, error) {
	ret := _m.Called(ctx, configMap, id)

	var r0 []types.GroupEntity
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *config.ConfigMap, string) ([]types.GroupEntity, error)); ok {
		return rf(ctx, configMap, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *config.ConfigMap, string) []types.GroupEntity); ok {
...
func (_c *MockIAMRepository_GetGroups_Call) Return(_a0 []types.GroupEntity, _a1 error) *MockIAMRepository_GetGroups_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIAMRepository_GetGroups_Call) RunAndReturn(run func(context.Context, *config.ConfigMap, string) ([]types.GroupEntity, error)) *MockIAMRepository_GetGroups_Call {
	_c.Call.Return(run)
	return _c
}

// GetIamPolicy provides a mock function with given fields: ctx, configMap, id
func (_m *MockIAMRepository) GetIamPolicy(ctx context.Context, configMap *config.ConfigMap, id string) (types.IAMPolicyContainer, error) {
	ret := _m.Called(ctx, configMap, id)

	var r0 types.IAMPolicyContainer
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *config.ConfigMap, string) (types.IAMPolicyContainer, error)); ok {
		return rf(ctx, configMap, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *config.ConfigMap, string) types.IAMPolicyContainer); ok {
		r0 = rf(ctx, configMap, id)
	} else {
		r0 = ret.Get(0).(types.IAMPolicyContainer)
	}
...
func (_c *MockIAMRepository_GetIamPolicy_Call) Return(_a0 types.IAMPolicyContainer, _a1 error) *MockIAMRepository_GetIamPolicy_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIAMRepository_GetIamPolicy_Call) RunAndReturn(run func(context.Context, *config.ConfigMap, string) (types.IAMPolicyContainer, error)) *MockIAMRepository_GetIamPolicy_Call {
	_c.Call.Return(run)
	return _c
}

// GetServiceAccounts provides a mock function with given fields: ctx, configMap, id
func (_m *MockIAMRepository) GetServiceAccounts(ctx context.Context, configMap *config.ConfigMap, id string) ([]types.UserEntity, error) {
	ret := _m.Called(ctx, configMap, id)

	var r0 []types.UserEntity
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *config.ConfigMap, string) ([]types.UserEntity, error)); ok {
		return rf(ctx, configMap, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *config.ConfigMap, string) []types.UserEntity); ok {
		r0 = rf(ctx, configMap, id)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockIAMRepository_GetServiceAccounts_Call) Return(_a0 []types.UserEntity, _a1 error) *MockIAMRepository_GetServiceAccounts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIAMRepository_GetServiceAccounts_Call) RunAndReturn(run func(context.Context, *config.ConfigMap, string) ([]types.UserEntity, error)) *MockIAMRepository_GetServiceAccounts_Call {
	_c.Call.Return(run)
	return _c
}

// GetUsers provides a mock function with given fields: ctx, configMap, id
func (_m *MockIAMRepository) GetUsers(ctx context.Context, configMap *config.ConfigMap, id string) ([]types.UserEntity, error) {
	ret := _m.Called(ctx, configMap, id)
...
func (_c *MockIAMRepository_GetUsers_Call) Return(_a0 []types.UserEntity, _a1 error) *MockIAMRepository_GetUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIAMRepository_GetUsers_Call) RunAndReturn(run func(context.Context, *config.ConfigMap, string) ([]types.UserEntity, error)) *MockIAMRepository_GetUsers_Call {
	_c.Call.Return(run)
	return _c
}
