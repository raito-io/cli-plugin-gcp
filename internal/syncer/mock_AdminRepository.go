...
func (_m *MockAdminRepository) GetGroups(ctx context.Context, fn func(context.Context, *types.GroupEntity) error) error {
	ret := _m.Called(ctx, fn)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(context.Context, *types.GroupEntity) error) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - fn func(context.Context , *types.GroupEntity) error
...
func (_c *MockAdminRepository_GetGroups_Call) Run(run func(ctx context.Context, fn func(context.Context, *types.GroupEntity) error)) *MockAdminRepository_GetGroups_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(context.Context, *types.GroupEntity) error))
	})
	return _c
}
...
func (_c *MockAdminRepository_GetGroups_Call) RunAndReturn(run func(context.Context, func(context.Context, *types.GroupEntity) error) error) *MockAdminRepository_GetGroups_Call {
	_c.Call.Return(run)
	return _c
}

// GetUsers provides a mock function with given fields: ctx, fn
func (_m *MockAdminRepository) GetUsers(ctx context.Context, fn func(context.Context, *types.UserEntity) error) error {
	ret := _m.Called(ctx, fn)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(context.Context, *types.UserEntity) error) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - fn func(context.Context , *types.UserEntity) error
...
func (_c *MockAdminRepository_GetUsers_Call) Run(run func(ctx context.Context, fn func(context.Context, *types.UserEntity) error)) *MockAdminRepository_GetUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(context.Context, *types.UserEntity) error))
	})
	return _c
}
...
func (_c *MockAdminRepository_GetUsers_Call) RunAndReturn(run func(context.Context, func(context.Context, *types.UserEntity) error) error) *MockAdminRepository_GetUsers_Call {
	_c.Call.Return(run)
	return _c
}
